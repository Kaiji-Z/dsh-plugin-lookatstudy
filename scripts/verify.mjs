...
gate('bundle', () => {
  ...
  const required = [
    ...
    [client, 'lks-readbar', 'read-aloud bar (0.13.0)'],
    [client, 'read.engine.system', 'read-aloud degradation notice'],
    [client, 'speechSentencesOf', 'sentence splitter rides the client bundle (0.13.0)'],
    [client, 'speechSynthesis', 'system-voice fallback engine (0.13.0)'],
