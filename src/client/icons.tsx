...
export function IconBookOutline16({ size = 16, className }: IconProps) {
  return createElement('svg', {
    width: size, height: size, className, viewBox: '0 0 16 16', fill: 'none', xmlns: 'http://www.w3.org/2000/svg',
  },
    createElement('path', { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M2 2.5C2 1.67157 2.67157 1 3.5 1H12.5C13.3284 1 14 1.67157 14 2.5V12.5C14 13.3284 13.3284 14 12.5 14H3.5C2.67157 14 2 13.3284 2 12.5V2.5ZM3.5 2C3.22386 2 3 2.22386 3 2.5V12.5C3 12.7761 3.22386 13 3.5 13H4V3H3.5ZM5 3V13H12.5C12.7761 13 13 12.7761 13 12.5V2.5C13 2.22386 12.7761 2 12.5 2H5ZM6 4.5H11.5V5.5H6V4.5ZM6 7H11.5V8H6V7ZM6 9.5H10V10.5H6V9.5Z', fill: 'currentColor' }))
}

/** IconPenOutline16 — plugin-original learning-domain companion (notes tab). */
export function IconPenOutline16({ size = 16, className }: IconProps) {
  return createElement('svg', {
    width: size, height: size, className, viewBox: '0 0 16 16', fill: 'none', xmlns: 'http://www.w3.org/2000/svg',
  },
    createElement('path', { fillRule: 'evenodd', clipRule: 'evenodd', d: 'M11.4503 1.65669C12.0849 1.02209 13.1145 1.02209 13.7491 1.65669L14.3433 2.25091C14.9779 2.88551 14.9779 3.91507 14.3433 4.54967L6.13604 12.7569L2.33156 13.7212C1.92166 13.8248 1.54569 13.4488 1.64934 13.0389L2.61359 9.23442L10.8208 1.02719L11.4503 1.65669ZM11.5317 2.66034L3.61621 10.5758L3.04325 12.8379L4.3433 12.5094L12.2987 4.55397L11.5317 2.78695V2.66034Z', fill: 'currentColor' }))
}
