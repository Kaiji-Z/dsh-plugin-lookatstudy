...
.lks-rail-head .lks-btn{padding:3px 8px;font-size:12px}
.lks-rail-title{font-size:14px;font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.lks-rail-sub{font-size:12px;color:var(--dsw-alias-label-tertiary);margin:4px 0 6px}
...
.lks-search{width:100%;box-sizing:border-box;background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:8px;color:var(--dsw-alias-label-primary);font-family:inherit;font-size:12.5px;padding:5px 9px;margin-bottom:4px}
.lks-search:focus{outline:none;border-color:var(--dsw-alias-state-business-primary)}
.lks-sec-num{display:inline-flex;align-items:center;justify-content:center;min-width:18px;height:18px;border-radius:50%;background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label);font-size:10px;font-weight:700;margin-right:4px}
...
.lks-input{flex:1;min-width:0;resize:none;background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l2);border-radius:10px;color:var(--dsw-alias-label-primary);font-family:inherit;font-size:13px;line-height:1.6;padding:8px 10px}
.lks-input:focus{outline:none;border-color:var(--dsw-alias-state-business-primary)}
.lks-input:disabled{opacity:.55}
.lks-import-hint{font-size:11.5px;color:var(--dsw-alias-label-tertiary);margin-top:6px;line-height:1.7}
.lks-duebox{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1);border-radius:10px;padding:10px 12px;margin:8px 0 14px;font-size:12.5px}
...
.lks-sec{font-size:11px;color:var(--dsw-alias-label-tertiary);text-transform:uppercase;letter-spacing:.05em;margin:14px 0 4px}
...
.lks-node .lks-t{flex:1;font-size:13px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
.lks-node.locked{opacity:.45;cursor:not-allowed}
.lks-node.locked:hover{background:none}
.lks-tag{font-size:10px;border-radius:4px;padding:0 4px;flex:none}
...
.lks-pct{font-size:11px;color:var(--dsw-alias-label-tertiary);flex:none;width:32px;text-align:right}
...
.lks-msg.tool{align-self:flex-start;font-size:11px;color:var(--dsw-alias-label-tertiary);background:none;border-radius:0;padding:1px 2px}
.lks-msg.error{align-self:stretch;color:var(--dsw-alias-state-error-primary);font-size:12px;background:none;border-radius:0;padding:1px 2px}
...
.lks-starter{border:1px solid var(--dsw-alias-border-l2);border-radius:999px;padding:3px 12px;font-size:12px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-2);transition:border-color .12s ease,color .12s ease}
...
.lks-lessonhead h2{font-size:17px;margin:0 0 4px;font-weight:700}
.lks-lessonhead .lks-meta{color:var(--dsw-alias-label-tertiary);font-size:12px;margin-bottom:4px}
.lks-chips{display:flex;flex-wrap:wrap;gap:6px;margin:8px 0}
.lks-chip{border-radius:999px;padding:2px 10px;font-size:11px;background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-secondary)}
...
.lks-prose{font-size:13.5px;line-height:1.7}
.lks-prose h1,.lks-prose h2,.lks-prose h3,.lks-prose h4{margin:14px 0 6px;line-height:1.4}
.lks-prose p{margin:6px 0}
.lks-prose pre{background:var(--dsw-alias-markdown-code-block);border:1px solid var(--dsw-alias-border-l1);border-radius:10px;padding:10px;overflow-x:auto;margin:8px 0;font-size:12.5px;font-family:var(--dsw-font-markdown-code-block-small)}
...
.lks-prose th,.lks-prose td{border:1px solid var(--dsw-alias-border-l2);padding:5px 11px;font-size:13px}
...
.lks-zone h4{font-size:13px;color:var(--dsw-alias-label-secondary);margin:0 0 8px;font-weight:600}
